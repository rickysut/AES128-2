    ...
    public static void setTheme(Theme theme, Scene scene) {
        ...
        switch (theme) {
            case DEFAULT:
                ...
                String css = MDICanvas.class.getResource("/styles/DefaultTheme.css").toExternalForm();
                scene.getStylesheets().clear();
            ...
            case DARK:
                ...
                //scene.getStylesheets().clear();
                //scene.getStylesheets().add("file:///" + f.getAbsolutePath().replace("\\", "/"));
                String cssDark = MDICanvas.class.getResource("/styles/DarkTheme.css").toExternalForm();
                scene.getStylesheets().clear();
